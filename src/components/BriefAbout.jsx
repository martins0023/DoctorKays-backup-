...
import { bouncex, slideInFromLeft, slideInFromTop, staggerContainer } from "../constants/animations";
      ...
      <div className="flex flex-wrap justify-center">
        <div className="p-2 w-full lg:w-1/2">
          <div className="flex flex-col gap-2">
            <motion.img variants={slideInFromTop} src={doctor1} alt="doctor" className="rounded-xl" />
            <motion.p variants={slideInFromLeft} className="text-md text-neutral-500">
        ...
        <div className="pt-12 w-full lg:w-1/2">
          {checkaboutlists.map((item, index) => (
            <div key={index} className="flex mb-12">
              <motion.div variants={bouncex} className="text-purple-400 mx-6 bg-neutral-900 h-10 w-10 p-2 justify-center items-center rounded-full">
                {item.icon}
              </motion.div>
              <div>
